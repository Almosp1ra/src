...
public:
	...
	static const int CMD_MAX_LEN = 128;
	char m_History[HISTORY_SIZE][CMD_MAX_LEN];
	int m_HistoryHead;      /* Next slot to write */
	int m_HistoryCount;     /* Total saved history count (up to HISTORY_SIZE) */
	int m_HistoryCurrentIndex; /* Index currently viewing (-1 if typing new line) */
